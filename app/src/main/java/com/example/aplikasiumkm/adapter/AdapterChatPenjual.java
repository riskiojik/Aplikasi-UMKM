...
public class AdapterChatPenjual extends RecyclerView.Adapter<AdapterChatPenjual.MyHolder> {
    ...
    public AdapterChatPenjual(Context context, ArrayList<ModelChat> chatArrayList, String profileImage) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        // Set pesan dan waktu ke ViewHolder
        ...
        // Tampilkan status "Dilihat" atau "Menunggu" di pesan terakhir
