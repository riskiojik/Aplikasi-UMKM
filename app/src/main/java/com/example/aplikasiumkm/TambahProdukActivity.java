...
public class TambahProdukActivity extends AppCompatActivity {
    ...
    private void addProduk() {
        //simpanData
        progressDialog.setMessage("Tambah Produk Anda");
        progressDialog.show();
        ...
        databaseReference.child(firebaseAuth.getUid()).child("Produk").child(timestamp).setValue(hashMap)
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(TambahProdukActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT);
            }
        });

    }else {
            String filePatAndName = "gambar_produk/" + "" + timestamp;
            StorageReference storageReference = FirebaseStorage.getInstance().getReference(filePatAndName);
    ...
    private void clearData() {
        ...
        quantityEt.setText("");
        priceEt.setText("");
        diskonHargaEt.setText("");
        diskonHargaNoteEt.setText("");
        produkIconIv.setImageResource(R.drawable.ic_baseline_add_shopping_cart);
        image_uri = null;
    }
