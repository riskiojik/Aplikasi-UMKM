...
public class FilterProduk extends Filter {

    private AdapterProdukPenjual adapter;
    private ArrayList<ModelProduk>filterList;

    public FilterProduk(AdapterProdukPenjual adapter, ArrayList<ModelProduk> filterList) {
